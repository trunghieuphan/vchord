 ...
 * DAO for table LEVEL.
*/
public class LevelDao extends AbstractDao<Level, Integer> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(Level entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(Level entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
