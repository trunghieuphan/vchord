...
function info() {
    ...
    else s3 = s3 + a[(parseInt(f[2]) + 4) % 12].substring(0, 5) + "\t"; if (f[1].substring(1, 2) == "1") s3 = s3 + "-\t";
    else s3 = s3 + a[(parseInt(f[3]) + 9) % 12].substring(0, 5) + "\t"; if (f[1].substring(2, 3) == "1") s3 = s3 + "-\t";
    else s3 = s3 + a[(parseInt(f[4]) + 2) % 12].substring(0, 5) + "\t"; if (f[1].substring(3, 4) == "1") s3 = s3 + "-\t";
    else s3 = s3 + a[(parseInt(f[5]) + 7) % 12].substring(0, 5) + "\t"; if (f[1].substring(4, 5) == "1") s3 = s3 + "-\t";
    else s3 = s3 + a[(parseInt(f[6]) + 11) % 12].substring(0, 5) + "\t"; if (f[1].substring(5, 6) == "1") s3 = s3 + "-\t";
...
function gen() {
    ...
    var s0, s1, s2, i, i2, f, result;
	
	for (l1 = 0; l1 < document.guitar.chord.length; l1++)
	{
		document.guitar.chord.selectedIndex = l1;
		for(l2 = 0; l2 < document.guitar.majmin.length; l2++)
		{
			document.guitar.majmin.selectedIndex = l2;
			...
			if (document.guitar.elements.ChordArt[0].checked) {
				...
				if (document.guitar.elements.ChordArt[0].checked) 
				{
					t = document.guitar.chord.options[i].text + i2;
					t2 = document.guitar.chord.options[i].text;
				}
				else 
					t = i2;
			}
			...
			s1 = "String:\t" + s1;
			s2 = parseInt(f[2]) + " " + parseInt(f[3]) + " " + parseInt(f[4]) + " " + parseInt(f[5]) + " " + parseInt(f[6]) + " " + parseInt(f[7]) + " ";
			s3 = "Note:\t" + s3;
	...
	document.guitar.chordlist.value = result;
    ...
    if (document.guitar.elements.ChordArt[0].checked) {
        ...
        for (o = f[0]; o >= 2; o--) {
            ...
            if (f[1].substring(o - 2, o - 1) == "2") {
                ...
                for (tp = o; tp <= f[0]; tp++)
                    if (f[1].substring(tp - 2, tp - 1) == "0")
                        if (tp == 7) document.images[7 - tp + 6 * tm + versch].src = "x/full5.gif";
        ...
        if (parseInt(f[1]) > 0)
            for (o = 0; o < 6; o++)
                if (f[1].substring(o, o + 1) == "1") document.images[5 - o + versch].src = "x/full2.gif";
